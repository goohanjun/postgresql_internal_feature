					...
					const char *construct)
{
	...
	hashed_p.ml_agg_startup_cost = input_path->ml_agg_total_cost + hashed_p.ml_node_startup_cost;
	hashed_p.ml_agg_total_cost = input_path->ml_agg_total_cost + hashed_p.ml_node_total_cost;
	hashed_p.ml_agg_startup_std_cost = input_path->ml_agg_startup_std_cost + hashed_p.ml_node_startup_std_cost;
	hashed_p.ml_agg_total_std_cost = input_path->ml_agg_total_std_cost + hashed_p.ml_node_total_std_cost;
	...
	sorted_p.ml_agg_startup_cost = input_path->ml_agg_total_cost + sorted_p.ml_node_startup_cost;
	sorted_p.ml_agg_total_cost = input_path->ml_agg_total_cost + sorted_p.ml_node_total_cost;
	sorted_p.ml_agg_startup_std_cost = input_path->ml_agg_startup_std_cost + sorted_p.ml_node_startup_std_cost;
	sorted_p.ml_agg_total_std_cost = input_path->ml_agg_total_std_cost + sorted_p.ml_node_total_std_cost;
	...
	sorted_p.ml_agg_startup_cost += sorted_p.ml_node_startup_cost;
	sorted_p.ml_agg_total_cost += sorted_p.ml_node_total_cost;
	sorted_p.ml_agg_startup_std_cost +=  sorted_p.ml_node_startup_std_cost;
	sorted_p.ml_agg_total_std_cost += sorted_p.ml_node_total_std_cost;
