...
// END2END >>>>>
    ...
    {
        {"use_cost_ml_server", PGC_USERSET, UNGROUPED,
            gettext_noop("Enable computing cost from server with ML models."),
            NULL
        },
        &use_cost_ml_server,
        false,
	...
	{
        {"use_join_ml_only", PGC_USERSET, UNGROUPED,
            gettext_noop("Enable computing cost from server with ML models for join nodes only."),
            NULL
        },
        &use_join_ml_only,
        false,
	...
	{
        {"print_plan_opt_path", PGC_USERSET, UNGROUPED,
            gettext_noop("Enable optimizer plan path printing."),
            NULL
        },
        &print_plan_opt_path,
        false,
	...
	{
        {"print_nn_cost_features", PGC_USERSET, UNGROUPED,
            gettext_noop("Enable printing cost input features for training ml model."),
            NULL
        },
	...
	{
        {"print_ml_cost_features", PGC_USERSET, UNGROUPED,
            gettext_noop("Enable printing cost input features for training ml model."),
            NULL
        },
...
{
	{
		{"ml_lambda_worst_case_minimization", PGC_USERSET, UNGROUPED,
			gettext_noop("Sets alpha value in ml model, when you use worst-case minimization, mu + alpha * std"),
			NULL,
			GUC_EXPLAIN
		},
		&ml_lambda_worst_case_minimization,
		0., 0, DBL_MAX,
		NULL, NULL, NULL
	},
	{
...
// END2END >>>>>
	{
        {"addr_cost_ml_server", PGC_USERSET, UNGROUPED,
            gettext_noop("Address of server which serves ml cost models"),
            NULL,
            GUC_IS_NAME
        },
        &addr_cost_ml_server,
