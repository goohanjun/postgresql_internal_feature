...
static void
CopyPlanNNFields(const Plan *from, Plan *newnode)
{
	COPY_SCALAR_FIELD(ml_node_startup_cost);
	COPY_SCALAR_FIELD(ml_node_total_cost);
	COPY_SCALAR_FIELD(ml_node_startup_std_cost);
	COPY_SCALAR_FIELD(ml_node_total_std_cost);

	COPY_SCALAR_FIELD(ml_agg_startup_cost);
	COPY_SCALAR_FIELD(ml_agg_total_cost);
	COPY_SCALAR_FIELD(ml_agg_startup_std_cost);
	COPY_SCALAR_FIELD(ml_agg_total_std_cost);

	COPY_SCALAR_FIELD(ml_inner_run_cost);
	COPY_SCALAR_FIELD(ml_inner_rescan_run_cost);
	COPY_SCALAR_FIELD(ml_inner_rescan_start_cost);

	COPY_SCALAR_FIELD(nn_sort_left);
	COPY_SCALAR_FIELD(ml_sort_left_cost);
	COPY_SCALAR_FIELD(ml_sort_left_std_cost);

	COPY_SCALAR_FIELD(nn_sort_right);
	COPY_SCALAR_FIELD(ml_sort_right_cost);
	COPY_SCALAR_FIELD(ml_sort_right_std_cost);

	COPY_SCALAR_FIELD(nn_restrict_qual_cost_startup);
	COPY_SCALAR_FIELD(nn_pathtarget_cost_startup);
	COPY_SCALAR_FIELD(nn_pathtarget_cost_per_tuple);

	COPY_SCALAR_FIELD(nn_outer_path_rows);
	COPY_SCALAR_FIELD(nn_inner_path_rows);
	COPY_SCALAR_FIELD(nn_path_rows);
	COPY_SCALAR_FIELD(nn_per_tuple);
	COPY_SCALAR_FIELD(nn_outer_matched_rows);
	COPY_SCALAR_FIELD(nn_outer_unmatched_rows);
	COPY_SCALAR_FIELD(nn_inner_scan_frac);
	COPY_SCALAR_FIELD(nn_ntuples);
	COPY_SCALAR_FIELD(nn_parallel_worker);
	COPY_SCALAR_FIELD(nn_jointype);
	COPY_SCALAR_FIELD(nn_match_count);
	COPY_SCALAR_FIELD(nn_inner_unique);
	COPY_SCALAR_FIELD(nn_has_indexed_join_quals);
	COPY_SCALAR_FIELD(nn_outer_rows);
	COPY_SCALAR_FIELD(nn_inner_rows);
	COPY_SCALAR_FIELD(nn_outer_skip_rows);
	COPY_SCALAR_FIELD(nn_inner_skip_rows);
	
	COPY_SCALAR_FIELD(nn_rescanratio);
	COPY_SCALAR_FIELD(nn_outerstartsel);
	COPY_SCALAR_FIELD(nn_outerendsel);
	COPY_SCALAR_FIELD(nn_innerstartsel);
	COPY_SCALAR_FIELD(nn_innerendsel);
	COPY_SCALAR_FIELD(nn_merge_qual_cost_startup);
	COPY_SCALAR_FIELD(nn_merge_qual_cost_per_tuple);
	COPY_SCALAR_FIELD(nn_qp_qual_cost_startup);
	COPY_SCALAR_FIELD(nn_qp_qual_cost_per_tuple);
	COPY_SCALAR_FIELD(nn_mergejointuples);
	COPY_SCALAR_FIELD(nn_rescannedtuples);
	COPY_SCALAR_FIELD(nn_materialize_inner);
	COPY_SCALAR_FIELD(nn_skip_mark_restore);
	COPY_SCALAR_FIELD(nn_numbuckets);
	COPY_SCALAR_FIELD(nn_numbatches);
	COPY_SCALAR_FIELD(nn_num_hashclauses);
	COPY_SCALAR_FIELD(nn_outerpages);
	COPY_SCALAR_FIELD(nn_innerpages);
	COPY_SCALAR_FIELD(nn_inner_path_rows_total);
	COPY_SCALAR_FIELD(nn_hashjointuples);
	COPY_SCALAR_FIELD(nn_virtualbuckets);
	COPY_SCALAR_FIELD(nn_innerbucketsize);
	COPY_SCALAR_FIELD(nn_innermcvfreq);
	COPY_SCALAR_FIELD(nn_hash_qual_cost_startup);
	COPY_SCALAR_FIELD(nn_hash_qual_cost_per_tuple);
	COPY_SCALAR_FIELD(nn_spc_seq_page_cost);
	COPY_SCALAR_FIELD(nn_pages);
	COPY_SCALAR_FIELD(nn_spc_random_page_cost);
	COPY_SCALAR_FIELD(nn_comparison_cost);
	COPY_SCALAR_FIELD(nn_parallel_tuple_cost);
	COPY_SCALAR_FIELD(nn_num_workers);
	COPY_SCALAR_FIELD(nn_indexStartupCost);
	COPY_SCALAR_FIELD(nn_indexTotalCost);
	COPY_SCALAR_FIELD(nn_indexselectivity);
	COPY_SCALAR_FIELD(nn_indexcorrelation);
	COPY_SCALAR_FIELD(nn_indexpage);
	COPY_SCALAR_FIELD(nn_max_pages_fetched);
	COPY_SCALAR_FIELD(nn_min_pages_fetched);
	COPY_SCALAR_FIELD(nn_max_IO_cost);
	COPY_SCALAR_FIELD(nn_min_IO_cost);
	COPY_SCALAR_FIELD(nn_loopcount);
	COPY_SCALAR_FIELD(nn_indexonly);
	COPY_SCALAR_FIELD(nn_partial_path);
	COPY_SCALAR_FIELD(nn_pages_fetched);
	COPY_SCALAR_FIELD(nn_selectivity);
	COPY_SCALAR_FIELD(nn_iscurrentof);
	COPY_SCALAR_FIELD(nn_scan_qual_cost_startup);
	COPY_SCALAR_FIELD(nn_scan_qual_cost_per_tuple);
	COPY_SCALAR_FIELD(nn_ngroup);
	COPY_SCALAR_FIELD(nn_group_startup_cost);
	COPY_SCALAR_FIELD(nn_group_run_cost);
	COPY_SCALAR_FIELD(nn_group_input_run_cost);
	COPY_SCALAR_FIELD(nn_nstream);
	COPY_SCALAR_FIELD(nn_material_nbytes);
	COPY_SCALAR_FIELD(nn_aggstrategy);
	COPY_SCALAR_FIELD(nn_numGroups);
	COPY_SCALAR_FIELD(nn_output_tables);
	COPY_SCALAR_FIELD(nn_ngroups);
	COPY_SCALAR_FIELD(nn_ngroupcols);
	COPY_SCALAR_FIELD(nn_input_width);
	COPY_SCALAR_FIELD(nn_ngroups_limit);
	COPY_SCALAR_FIELD(nn_num_partitions);
	COPY_SCALAR_FIELD(nn_depth);
	COPY_SCALAR_FIELD(nn_agg_transcost_startup);
	COPY_SCALAR_FIELD(nn_agg_transcost_per_tuple);
	COPY_SCALAR_FIELD(nn_agg_finalcost_startup);
	COPY_SCALAR_FIELD(nn_agg_finalcost_per_tuple);
	COPY_SCALAR_FIELD(nn_pages_written);
	COPY_SCALAR_FIELD(nn_pages_read);
	COPY_SCALAR_FIELD(nn_hashentrysize);
	COPY_SCALAR_FIELD(nn_nbatches);
	COPY_SCALAR_FIELD(nn_numpartcols);
	COPY_SCALAR_FIELD(nn_numordercols);
	COPY_SCALAR_FIELD(nn_numgroupcols);

	/* Index */
	COPY_SCALAR_FIELD(nn_baserel_pages);
	COPY_SCALAR_FIELD(nn_baserel_allvisfrac);
	COPY_SCALAR_FIELD(nn_index_unique);
	COPY_SCALAR_FIELD(nn_index_pages);
	COPY_SCALAR_FIELD(nn_index_tree_height);
	COPY_SCALAR_FIELD(nn_index_ncolumns);
	COPY_SCALAR_FIELD(nn_index_nkeycolumns);
	COPY_SCALAR_FIELD(nn_index_tuples);
	
	COPY_SCALAR_FIELD(nn_index_StartupCost);
	COPY_SCALAR_FIELD(nn_index_indexTotalCost);
	COPY_SCALAR_FIELD(nn_index_numIndexPages);
	COPY_SCALAR_FIELD(nn_index_numIndexTuples);
	COPY_SCALAR_FIELD(nn_index_spc_random_page_cost);
	COPY_SCALAR_FIELD(nn_index_num_sa_scans);

	/* Equations */
	COPY_SCALAR_FIELD(nn_eq_1);
	COPY_SCALAR_FIELD(nn_eq_2);
	COPY_SCALAR_FIELD(nn_eq_3);
	COPY_SCALAR_FIELD(nn_eq_4);
	COPY_SCALAR_FIELD(nn_eq_5);
	COPY_SCALAR_FIELD(nn_eq_6);
	COPY_SCALAR_FIELD(nn_eq_7);
	COPY_SCALAR_FIELD(nn_eq_8);
	COPY_SCALAR_FIELD(nn_eq_9);
	COPY_SCALAR_FIELD(nn_eq_10);
	COPY_SCALAR_FIELD(nn_eq_11);
	COPY_SCALAR_FIELD(nn_eq_12);
	COPY_SCALAR_FIELD(nn_eq_13);
	COPY_SCALAR_FIELD(nn_eq_14);
}
