...
typedef struct Path
{
	...
	double			ml_node_startup_cost;
	double			ml_node_total_cost;
	double			ml_node_startup_std_cost;
	double			ml_node_total_std_cost;
	
	double			ml_agg_startup_cost;
	double			ml_agg_total_cost;
	double			ml_agg_startup_std_cost;
	double			ml_agg_total_std_cost;
	
	double			ml_inner_run_cost;
	double			ml_inner_rescan_run_cost;
	double			ml_inner_rescan_start_cost;

	bool			nn_sort_left;
	double			ml_sort_left_cost;
	double			ml_sort_left_std_cost;
	
	bool			nn_sort_right;
	double			ml_sort_right_cost;
	double			ml_sort_right_std_cost;
	
	/* nestloop */
	double			nn_outer_path_rows;
	double			nn_inner_path_rows;
	double			nn_path_rows;
	double 			nn_per_tuple;

	double			nn_restrict_qual_cost_startup;
	double			nn_pathtarget_cost_startup;
	double			nn_pathtarget_cost_per_tuple;

	double			nn_outer_matched_rows;
	double			nn_outer_unmatched_rows;
	double			nn_inner_scan_frac;

	double 			nn_ntuples;
	int 			nn_parallel_worker;
	int				nn_jointype;
	double			nn_match_count;
	bool 			nn_inner_unique;
	bool			nn_has_indexed_join_quals;

	/* merge */
	double 			nn_outer_rows;
	double 			nn_inner_rows;
	double 			nn_outer_skip_rows;
	double 			nn_inner_skip_rows;
	
	double 			nn_rescanratio;
	double 			nn_outerstartsel;
	double 			nn_outerendsel;
	double 			nn_innerstartsel;
	double 			nn_innerendsel;

	double 			nn_merge_qual_cost_startup;
	double 			nn_merge_qual_cost_per_tuple;
	double 			nn_qp_qual_cost_startup;
	double 			nn_qp_qual_cost_per_tuple;
	double 			nn_mergejointuples;
	double 			nn_rescannedtuples;
	bool 			nn_materialize_inner;
	bool			nn_skip_mark_restore;
	
	/* hash */
	int 			nn_numbuckets;
	int 			nn_numbatches;
	int 			nn_num_hashclauses;
	double 			nn_innerpages;
	double 			nn_outerpages;
	double 			nn_inner_path_rows_total;
	double 			nn_hashjointuples;
	double 			nn_virtualbuckets;
	double 			nn_innerbucketsize;
	double 			nn_innermcvfreq;
	double			nn_hash_qual_cost_startup;
	double			nn_hash_qual_cost_per_tuple;

	/* seqscan */
	double 			nn_spc_seq_page_cost;
	int				nn_pages;
	
	/* samplescan */
	double 			nn_spc_random_page_cost;

	/* gather */
	/* gather_merge */
	double 			nn_comparison_cost;
	double			nn_parallel_tuple_cost;
	int				nn_num_workers;
	
	/* index */
	double			nn_indexStartupCost;
	double			nn_indexTotalCost;
	double			nn_indexselectivity;
	double			nn_indexcorrelation;
	double			nn_indexpage;
	double			nn_max_pages_fetched;
	double 			nn_min_pages_fetched;
	double 			nn_max_IO_cost;
	double 			nn_min_IO_cost;
	int				nn_loopcount;
	bool			nn_indexonly;
	bool			nn_partial_path;

	/* bitmap_heap_scan */
	int				nn_pages_fetched;
	
	/* bitmap_and_node */
	double			nn_selectivity;

	/* tidscan */
	bool 			nn_iscurrentof;
	double 			nn_scan_qual_cost_startup;
	double 			nn_scan_qual_cost_per_tuple;
	
	/* incremental sort */
	int 			nn_ngroup;
	double 			nn_group_startup_cost;
	double 			nn_group_run_cost;
	double			nn_group_input_run_cost;

	/* merge_append */
	double 			nn_nstream;

	/* material */
	double 			nn_material_nbytes;

	/* agg */
	int				nn_aggstrategy;
	int				nn_numGroups;
	int				nn_output_tables;
	int 			nn_ngroups;
	int 			nn_ngroupcols;
	int 			nn_input_width;
	int				nn_ngroups_limit;
	int				nn_num_partitions;
	int				nn_depth;

	double			nn_agg_transcost_startup;
    double			nn_agg_transcost_per_tuple;
    double			nn_agg_finalcost_startup;
	double			nn_agg_finalcost_per_tuple;
	double			nn_pages_written;
	double			nn_pages_read;
	double			nn_hashentrysize;
	double			nn_nbatches;
	...
	/* index */
	double			nn_baserel_pages;
	double			nn_baserel_allvisfrac;
	int				nn_index_pages;
	double			nn_index_tuples;
	int				nn_index_tree_height;
	int				nn_index_ncolumns;
	int				nn_index_nkeycolumns;
	bool			nn_index_unique;
	
	/* genericcostestimate () */
	double			nn_index_StartupCost;
	double			nn_index_indexTotalCost;
	double			nn_index_numIndexPages;
	double			nn_index_numIndexTuples;
	double			nn_index_spc_random_page_cost;
	double			nn_index_num_sa_scans;
...
typedef struct JoinCostWorkspace
{
	...
	/* outer */
	bool		nn_sort_left;
	Cost		ml_sort_left_cost;
	Cost		ml_sort_left_std_cost;
	/* inner */
	bool		nn_sort_right;
	Cost		ml_sort_right_cost;
	Cost		ml_sort_right_std_cost;
	...
	Cost		ml_startup_cost;	/* cost expended before fetching any tuples */
	Cost		ml_total_cost;		/* total cost (assuming all tuples fetched) */
	Cost		ml_run_cost;		/* non-startup cost components */
	Cost		ml_inner_run_cost; /* also used by cost_mergejoin code */
